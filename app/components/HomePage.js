    ...
    <main>
        ...
        <div className="max-w-6xl mx-auto px-5 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-textSecondary max-w-xl">
              ...
              the art of astrophotography—inviting you to explore the wonders of
              our universe.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-bgSecondary rounded-xl2 p-6 shadow-soft border border-white/10">
              ...
              <p className="text-textSecondary text-sm">
                Astrophotography is challenging yet deeply rewarding—the results
                can be more satisfying than you ever imagined.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="gallery" className="bg-bgOverlay py-20">
        <div className="max-w-6xl mx-auto px-5">
          ...
          <Link href="/gallery" className="text-accentPrimary hover:underline">
            ...
            <div>
              ...
              <div className="mt-4 space-x-2">
                <a
                  ...
                  aria-label="Follow on Instagram"
                >
                  <button className="px-5 py-2 rounded-full bg-accentPrimary text-bgPrimary font-semibold hover:opacity-90">
                    Instagram
                  </button>
                </a>
